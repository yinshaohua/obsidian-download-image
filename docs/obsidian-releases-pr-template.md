...
Link to my plugin: https://github.com/yinshaohua/obsidian-download-image
...
- I have enabled Issues in the plugin repository so users can report bugs and request features.
